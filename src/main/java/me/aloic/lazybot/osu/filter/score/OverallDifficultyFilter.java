...
@AllArgsConstructor
public class OverallDifficultyFilter implements ScoreFilter
{
    ...
    public boolean filter(ScoreLazerDTO score) {
        return ScoreFilter.numericComparison(operator, score.getBeatmap().getAttributes().getOd(), threshold);
    }
