...
public class CardInfoColorPalette
{
    ...
    {
        return CardInfoColorPalette.builder()
                .leftBar(fill(hue, -9, 38, 25, 0))
                .nameBlock(fill(hue, 0, 22, 24, 0))
                .statsBlock(fill(hue, 1, 16, 28, 0))
                .footerJoin(fill(hue, 1, 36, 20, 0))
                .footerRank(fill(hue, -10, 30, 28, 0))
                .footerLevel(fill(hue, -10, 26, 36, 0))
                .footerAcc(fill(hue, -10, 20, 44, 0))
                .deco(fill(hue, 1, 41, 90, 0))
                .infoText("#e9ebea")
                .showStripes(true)
                .lowContrast(true)
                .build();
